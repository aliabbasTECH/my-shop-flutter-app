...
class _AuthCardState extends State<AuthCard> {
  ...
  void _showErrorDialoag(String message) {
    showDialog(
        context: context,
        builder: (ctx) => AlertDialog(
              ...
              actions: [
                TextButton(
                  child: Text("okey"),
                  onPressed: () {
                    Navigator.of(context).pop();  // this will close the show diloag 
                  },
                ),
              ],
            ));
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains("EMAIL_EXISTS")) {
        ...
        errorMeassage = "password is too weak ";
      } else if (error.toString().contains("EMAIL_NOT_FOUND")) {
        errorMeassage = "Could not find a user with that email.";
      } else if (error.toString().contains("INVALID_PASSWORD")) {
        errorMeassage = "invalid password.";
      }
      _showErrorDialoag(errorMeassage);
    } catch (error) {
      const errorMeassage = 'Authentication failed';
      _showErrorDialoag(errorMeassage);
    }
